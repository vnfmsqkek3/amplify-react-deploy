...
const DeviceViewer = () => {
  ...
  const callAPI = async () => {
    ...
    try {
        ...
        // Check if result.body is a string, then parse it. Otherwise, use it directly.
        const parsedDevices = typeof result.body === 'string' ? JSON.parse(result.body) : result.body;
